...
def parse_lnk(filename):
    ...
    with open(filename, 'rb') as f:
        ...
        lnk_info['create_time'] = ms_time_to_unix(int(create_time, 16))

        # Access time 8 bytes@ 0x24 = 36D
        access_time = reverse_hex(read_unpack(f,36,8))
        lnk_info['access_time'] = ms_time_to_unix(int(access_time, 16))

        # Modified Time8b @ 0x2C = 44D
        modified_time = reverse_hex(read_unpack(f,44,8))
        lnk_info['modified_time'] = ms_time_to_unix(int(modified_time, 16))
